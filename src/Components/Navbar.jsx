...
const Navbar = (props) => {
  ...
  return (
    <div className="flex  justify-around flex-wrap gap-2 items-center w-11/12 max-w-[1160px]  py-4 mx-auto">
      <Link to="/">
        <img src={logo} height={32} width={160} loading="lazy" alt = " pdhai"/>
      </Link>
